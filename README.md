...
2. Sigue las instrucciones de la [Wiki](https://github.com/capdibupm/normativa/wiki/Procesos-CAPDIB) para completar los formularios necesarios. En cada carpeta encontrarás un archivo `README.txt` con las instrucciones específicas.

[**EN**]
1. To download any of the folders from this repository click on the green `Code` button and select the `Download ZIP` option:
    - Click on the desired file (*e.g.* `docs_defense.zip`) as indicated in the image.
...
2. Follow the instructions in the [Wiki](https://github.com/capdibupm/normativa/wiki/Thesis-procedures-CAPDIB) to complete the necessary forms. In each folder you will find a `README.txt` file with specific instructions.
